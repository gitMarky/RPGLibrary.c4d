...
global func FadeOutNew(object pObject, int level, bool fFast, int iAmount, int iVisiblity)
{
	...
	if (GetEffect("*FadeOut*", pObject))
		return;
	if (fFast)
		return AddEffect("FadeOut", pObject, 101, 1, 0, 0, level, iAmount, iVisiblity);
...
global func FadeInNew(object pObject, int level, bool fFast, int iAmount, int iVisiblity)
{
	...
	if (GetEffect("*FadeIn*", pObject))
		return;
	if (fFast)
		return AddEffect("FadeIn", pObject, 101, 1, 0, 0, level, iAmount, iVisiblity);
