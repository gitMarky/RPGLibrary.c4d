...
public func ConstructDialogue( pPlayer )
{
	...
	//PushBack([-5,aList,"Hauptmenu","", 0, [LMM2,QuestColorMenu(),0,2,2,0], -1, "true", ["StopDialogue(pTarget)","Activate(pTarget)"] ],aDialogue);
}
...
protected func BuildQuestPages(int iPageIndex, object pPlayer, string szPageName, int iEntriesPerPage, array aQuestQueue, array &aDlgQuest, array &aDlgPages, array &aDlgDesc, array &aDlgDescPages)
{
	...
	//"StopDialogue(pTarget)"
	//PushBack([iPageIndex + 2*iMenuPages -1, aBackMenuList, "Hauptmenu", "",0,[LMM2,QuestColorMenu(),0,2,2,1], QuestLogArray()],aDlgPages);
	//PushBack([iPageIndex + 2*iMenuPages -1, aBackMenuList, "Hauptmenu", "",0,[LMM2,QuestColorMenu(),0,2,2,1], QuestLogArray(),0,Format("StartSpecificDialogue(pTarget,%d)",0)],aDlgPages);
...
protected func BuildQuestDescs(int iQuestMenuIndex, int iQuestPageIndex, int iPageIndex, object pPlayer, string szPageName, int iEntriesPerPage, array aDescQueue, array &aDlgDesc, array &aDlgPages)
{
	...
	//PushBack([iPageIndex + 2*iMenuPages -1, aBackMenuList, Format("Hauptmenu",iQuestMenuIndex), "",0,[LMM2,QuestColorMenu(),0,2,2,iQuestMenuIndex+1], QuestLogArray()],aDlgPages);
	//PushBack([iPageIndex + 2*iMenuPages -1, aBackMenuList, Format("Hauptmenu",iQuestMenuIndex), "",0,[LMM2,QuestColorMenu(),0,2,2,iQuestMenuIndex+1], QuestLogArray(),0,["StopDialogue(pTarget)",Format("StartSpecificDialogue(pTarget,%d)",iQuestMenuIndex)]],aDlgPages);
