...
public func MsgDialogueKing() {
	...
	DlgOption(5, -1, "Test 5")->Text("This was displayed red until you collected a rock")->Conditions("true")->Conditions("pTarget->FindContents(ROCK)")->RequiredConditions(1),
	DlgOption(6, -1, "Test 6")->Text("This text should be green")->TextColorMessage(RGB(0, 255, 0)),
	...
	DlgOption(10, -1, "Test 10")->Text("My text is white??")->DisableSpeakerColor(),
	DlgOption(11, -1, "Test 11")->Text("Either the option or the message is blue")->TextColorOption(RGB(0, 0, 255)),
